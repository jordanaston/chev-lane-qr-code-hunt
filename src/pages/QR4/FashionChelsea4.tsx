...
import ChelseaImage4 from "../../assets/Images/Chelsea-Image-4.png";

const FashionChelsea4: React.FC = () => {
  useEffect(() => {
    const middle =
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-center bg-cover bg-fixed text-justify">
      <div className="">
        <img src={ChelseaImage4} alt="Chev Lane Logo" className="w-80" />
...
export default FashionChelsea4;
